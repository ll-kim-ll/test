...
<script>
			...
			$('button').on('click', function() {
				switch ($(this).attr('id')) {
 					case "btnSearch": // 조회
	 					...
	 					break;
 					case "btnAdd": // 추가
 						WR.callPage('/device/commandClientInsert.do', $('#searchForm').serializeArray());
	 					break;
				}
			});
	...
	function loadData(){
		...
		WR.ajax.loadTblData('/device/commandClientList.do', searchForm, 'mainTable', 'pagination', function(result) {
	...
	function pagingProcess(page_id, page) {
		...
		loadData();
					...
					<div class="">
			      		<h4 class="page-header"><span class="glyphicon glyphicon-edit"></span> 사용자 <span class="glyphicon glyphicon-chevron-right"></span> 클라이언트 설정</h4>

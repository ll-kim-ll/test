...
/**
 * @Class Name : WRImageProcessController.java
 * @Description :
...
public class WRImageProcessController extends HttpServlet {

	@Autowired
    private WRFileMngService fileService;

    private static final Logger LOGGER = LoggerFactory.getLogger(WRImageProcessController.class);
    ...
    public void getImageInf(@RequestParam Map<String, Object> commandMap, HttpServletResponse response, ModelMap model) throws Exception {
		...
		WRFileVO fvo = fileService.selectFileInf(vo);

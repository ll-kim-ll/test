package com.wellrising.uds.util;
...
public class WRFormBasedUUID implements Serializable {
    /*
     ...
     */
    private WRFormBasedUUID(byte[] data) {
        long msb = 0;
        long lsb = 0;
        for (int i = 0; i < 8; i++)
     ...
     * @param leastSigBits
     */
    public WRFormBasedUUID(long mostSigBits, long leastSigBits) {
     ...
     */
    public static WRFormBasedUUID randomUUID() {
        ...
        return new WRFormBasedUUID(randomBytes);
    }
     ...
     */
    public static WRFormBasedUUID nameUUIDFromBytes(byte[] name) {
        MessageDigest md;
        try {
        ...
        return new WRFormBasedUUID(md5Bytes);
    }
     ...
     */
    public static WRFormBasedUUID fromString(String name) {
        ...
        return new WRFormBasedUUID(mostSigBits, leastSigBits);
    }
	...
	public boolean equals(Object obj) {
    	...
    	if (!(obj instanceof WRFormBasedUUID))
            return false;
        if (((WRFormBasedUUID) obj).variant() != this.variant())
            return false;
        WRFormBasedUUID id = (WRFormBasedUUID) obj;
     ...
     */
    public int compareTo(WRFormBasedUUID val) {
